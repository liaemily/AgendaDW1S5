...
<header class="d-flex flex-wrap justify-content-center border-bottom" style="background-color: #855CBF">
    ...
    <div class="collapse navbar-collapse" id="navbarTogglerDemo03">
        <ul class="navbar-nav mr-auto">
            <li class="nav-item">
                <a class="nav-link fw-bold text-uppercase"  style="color: #FFFFFF" href="/AgendaServlet/UserServlet">Voltar</a>
            </li>
        </ul>
        </div>
    </nav>
			...
			<div class="row g-3 align-items-center h-100">
				<div class="col-12">
	        		<div class="card bg-dark text-white">
	          			...
	          			<h2>Erro ao realizar cadastro, preencha o usuário corretamente!</h2>
	          			</div>
					</div>
				</div>
			</div>
