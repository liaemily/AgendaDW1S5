...
public class TarefaEditarServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		int id_editar = Integer.parseInt(request.getParameter("id_tarefa"));
		
		try {
			if (!tdao.tarefaExiste(id_editar)) {
				RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/tarefa_nao_existe_erro.jsp");
		...
		} catch (NumberFormatException | ClassNotFoundException | ServletException | IOException e) {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			if(!tdao.tarefaExiste(id_tarefa)) {
				RequestDispatcher dispatcher = request.getRequestDispatcher("/WEB-INF/view/tarefa_nao_existe_erro.jsp");
				dispatcher.forward(request, response);
